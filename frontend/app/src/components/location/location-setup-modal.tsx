...
// import { MapPin, Navigation, Loader2, AlertCircle, CheckCircle, Globe } from "lucide-react"
...
//     form.setValue("region", "") // Clear region
...
//             // Note: You might want to find and set the corresponding country object
//             // for the dropdown to work properly
//           }
//           if (locationData.region) {
//             form.setValue("region", locationData.region)
//           }
...
//             description: `${locationData.city}, ${locationData.region}, ${locationData.country}`,
//           })
//         } catch (error) {
...
//                 <span>GPS coordinates obtained</span>
//               </div>
//             )}
...
//                           containerClassName="w-full rounded-md border focus-within:ring-2"
...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from "@/components/ui/form"
import { MapPin, Navigation, Loader2, AlertCircle, CheckCircle, Globe, Satellite, Crosshair } from "lucide-react"
import { Alert, AlertDescription } from "@/components/ui/alert"
import { CountrySelect, StateSelect, CitySelect } from 'react-country-state-city'
import 'react-country-state-city/dist/react-country-state-city.css';
import { userApi } from "@/lib/api"
